...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param str1 a string representing the first word
     * @param str2 a string representing the second word
     */
    ...
    public boolean equals(Object o) {
        ...
        //       e.g. s1.equals(s2)
        return this.name.equals(((Silly) o).name) && ((Silly) o).name.equals(this.name);
    }
